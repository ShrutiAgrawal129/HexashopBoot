			...
			<div class="col-lg-6">
				<div class="left-content">
					<div class="thumb">
						...
						<img src="${pageContext.request.contextPath}/assets/images/left-banner-image.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="right-first-image">
								<div class="thumb">
									...
									<img src="${pageContext.request.contextPath}/assets/images/baner-right-image-01.jpg">
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="right-first-image">
								<div class="thumb">
									...
									<img src="${pageContext.request.contextPath}/assets/images/baner-right-image-02.jpg">
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="right-first-image">
								<div class="thumb">
									...
									<img src="${pageContext.request.contextPath}/assets/images/baner-right-image-03.jpg">
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="right-first-image">
								<div class="thumb">
									...
									<img src="${pageContext.request.contextPath}/assets/images/baner-right-image-04.jpg">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="men-item-carousel">
					...
					<c:forEach var="mproduct" items="${mproducts}">
						<div class="item">
							...
							<div>
								<h4>${mproduct.imgName}</h4><br>
								<span>Rs. ${mproduct.price}</span><br>
							    <div class="profile-actions">
						            <form action="addtocart" method="post">
						            	<input type="hidden" name="productId" value="${mproduct.id}" />
				...
				<div class="women-item-carousel">
					<div class="owl-women-item owl-carousel">
						...
						<div class="item">
							...
							<div>
								<h4>${wproduct.imgName}</h4><br>
								<span>Rs. ${wproduct.price}</span><br>
							    <div class="profile-actions">
						            <form action="addtocart" method="post">
						            	<input type="hidden" name="productId" value="${wproduct.id}" />
						                <input type="submit" name="addtocart" value="Add to Cart">    
						            </form>
					      	  	</div>
							</div>
				...
				<div class="kid-item-carousel">
					<div class="owl-kid-item owl-carousel">
						...
						<div class="item">
							...
							<div>
								<h4>${kproduct.imgName}</h4><br>
								<span>Rs. ${kproduct.price}</span><br>
							    <div class="profile-actions">
						            <form action="addtocart" method="post">
						            	<input type="hidden" name="productId" value="${kproduct.id}" />
						                <input type="submit" name="addtocart" value="Add to Cart">    
						            </form>
					      	  	</div>
							</div>
			...
			<div class="col-lg-6">
				<div class="left-content">
					...
					<span>You are allowed to use this HexaShop HTML CSS
						template. You can feel free to modify or edit this layout. You can
						convert this template as any kind of ecommerce CMS theme as you
						wish.</span>
					<div class="quote">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="first-image">
								<img src="${pageContext.request.contextPath}/assets/images/explore-image-01.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="second-image">
								<img src="${pageContext.request.contextPath}/assets/images/explore-image-02.jpg" alt="">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="types">
		...
		<div class="row images">
			<div class="col-2">
				<div class="thumb">
					...
					<img src="${pageContext.request.contextPath}/assets/images/instagram-01.jpg" alt="">
				</div>
			</div>
			<div class="col-2">
				<div class="thumb">
					...
					<img src="${pageContext.request.contextPath}/assets/images/instagram-02.jpg" alt="">
				</div>
			</div>
			<div class="col-2">
				<div class="thumb">
					...
					<img src="${pageContext.request.contextPath}/assets/images/instagram-03.jpg" alt="">
				</div>
			</div>
			<div class="col-2">
				<div class="thumb">
					...
					<img src="${pageContext.request.contextPath}/assets/images/instagram-04.jpg" alt="">
				</div>
			</div>
			<div class="col-2">
				<div class="thumb">
					...
					<img src="${pageContext.request.contextPath}/assets/images/instagram-05.jpg" alt="">
				</div>
			</div>
			<div class="col-2">
				<div class="thumb">
					...
					<img src="${pageContext.request.contextPath}/assets/images/instagram-06.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
